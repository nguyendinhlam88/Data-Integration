...
class ChototSpider(scrapy.Spider):
    ...
    def parse_ad(self, response):
        ...
        # item['mo_ta'] = response.xpath('//*[contains(concat( " ", @class, " " ), concat( " ", "AdDecription_adBody__1c8SG", " " ))]//text()').extract()

        item['thuoctinh_1'] = response.xpath('//span[contains(@itemprop, "price")]/text()').extract_first().replace(' đ', '')
        item['thuoctinh_2'] = response.xpath('//span[contains(@itemprop, "carbrand")]/text()').extract_first()
        item['thuoctinh_3'] = response.xpath('//span[contains(@itemprop, "carmodel")]/text()').extract_first()
        item['thuoctinh_4'] = response.xpath('//span[contains(@itemprop, "mfdate")]/text()').extract_first()
        item['thuoctinh_5'] = response.xpath('//span[contains(@itemprop, "condition")]/text()').extract_first()
        item['thuoctinh_6'] = response.xpath('//span[contains(@itemprop, "fuel")]/text()').extract_first()
        item['thuoctinh_7'] = response.xpath('//span[contains(@itemprop, "cartype")]/text()').extract_first()
        item['thuoctinh_8'] = response.xpath('//span[contains(@itemprop, "mileage")]/text()').extract_first()
        item['thuoctinh_9'] = response.xpath('//span[contains(@itemprop, "gearbox")]/text()').extract_first()
        item['thuoctinh_10'] = response.xpath('//span[contains(@itemprop, "origin")]/text()').extract_first()
        item['thuoctinh_11'] = response.xpath('//span[contains(@itemprop, "carseat")]/text()').extract_first()
        item['thuoctinh_12'] = response.xpath('//*[contains(concat( " ", @class, " " ), concat( " ", "AdDecription_adBody__1c8SG", " " ))]//text()').extract()
